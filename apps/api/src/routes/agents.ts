...
const BUILT_IN_AGENTS = [
  {
    ...
    tier: 'AGENT' as const,
    tools: ['search_gmail', 'read_email', 'search_google_drive', 'read_drive_document', 'update_drive_document', 'web_search', 'search_knowledge_base', 'get_graph_context', 'save_client_context', 'update_client_record', 'flag_for_review', 'browser_state', 'browser_visit', 'browser_close', 'browser_scrape', 'browser_screenshot', 'browser_key'],
  ...
  },
  {
    ...
    tier: 'AGENT' as const,
    tools: ['search_knowledge_base', 'get_competitive_context', 'get_graph_context', 'web_search', 'analyze_image', 'github_read_file', 'github_create_branch', 'github_write_file', 'github_create_pr', 'save_analysis', 'draft_email', 'flag_for_review', 'search_google_drive', 'read_drive_document', 'update_drive_document', 'browser_state', 'browser_visit', 'browser_close', 'browser_scrape', 'browser_screenshot', 'browser_scroll', 'browser_click', 'browser_fill', 'browser_key'],
  ...
  },
  {
    ...
    tier: 'AGENT' as const,
    tools: ['web_search', 'search_knowledge_base', 'get_market_context', 'get_competitive_context', 'get_graph_context', 'generate_comparison_matrix', 'save_competitor', 'flag_for_review', 'browser_state', 'browser_visit', 'browser_close', 'browser_scrape', 'browser_screenshot', 'browser_scroll', 'browser_click', 'browser_fill', 'browser_key'],
