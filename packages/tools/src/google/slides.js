...
function extractShapeText(shapeText) {
    if (!shapeText)
        return '';
 ...
 */
export async function getSlidesText(accessToken, presentationId) {
    ...
    console.log(`[getSlidesText] ${slides.length} slides — shapes: ${totalShapes}, tables: ${totalTables}, groups: ${totalGroups}, extracted: ${textParts.length} slides with text`);
